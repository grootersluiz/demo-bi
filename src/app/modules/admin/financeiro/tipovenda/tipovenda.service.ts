...
export class tipovendaService {
    ...
    getSeriesPie(): Observable<any> {
        ...
        return this._httpClient.get<{ columns: []; rows: [] }>(
            'http://api.portal.jspecas.com.br/v1/views/514/data?'+'filiais='+filiais
        );
    }
    getSeriesM1(): Observable<any> {
        var filiais = this.param.filial;
        return this._httpClient.get<{ columns: []; rows: [] }>(
            'http://api.portal.jspecas.com.br/v1/views/515/data?'+'filiais='+filiais
        );
    }
    getSeriesPie2(): Observable<any> {
        var filiais = this.param.filial;
        return this._httpClient.get<{ columns: []; rows: [] }>(
            'http://api.portal.jspecas.com.br/v1/views/517/data?'+'filiais='+filiais
        );
    }
    ...
    getSeriesHeat(): Observable<any> {
        var filiais = this.param.filial;
        return this._httpClient.get<{ columns: []; rows: [] }>(
            'http://api.portal.jspecas.com.br/v1/views/520/data?'+'filiais='+filiais
        );
    }
    getSeriesMixed(): Observable<any> {
        var filiais = this.param.filial;
        return this._httpClient.get<{ columns: []; rows: [] }>(
            'http://api.portal.jspecas.com.br/v1/views/523/data?'+'filiais='+filiais
        );
    }
